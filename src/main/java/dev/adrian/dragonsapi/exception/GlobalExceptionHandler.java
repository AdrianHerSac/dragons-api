...
/**
 * Manejador global de excepciones para proporcionar respuestas uniformes
 * en toda la API REST.
 *
 * @author dev.adrian
 * @version 1.0
...
public class GlobalExceptionHandler {
    ...
    /**
     * Maneja excepciones cuando no se encuentra un dragón.
     */
    @ExceptionHandler(DragonNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleDragonNotFound(
            DragonNotFoundException ex,
            HttpServletRequest request) {

        log.warn("Dragon not found: {}", ex.getMessage());
